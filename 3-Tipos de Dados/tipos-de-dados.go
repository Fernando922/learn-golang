...
func main() {
	...
	numero2 :=  1000000000000000000  //usa a arquitetura do seu pc 64 ou 32
	fmt.Println(numero)
	fmt.Println(numero2)
	...
	numeroReal3 := 12653.56  //de acordo com a arquitetura do procesador
	...
	char := 'B'  //inferiu o tipo RUNE
	fmt.Println(char)  //mostra o numero da tabela ascii


	//VALOR 'ZERO' 
	//toda variável tem seu valor zero, string é string vazia e numeros são 0
	var texto float64
	fmt.Println(texto)
